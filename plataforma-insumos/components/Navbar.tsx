...
export default function Navbar() {
  ...
  return (
    <nav className="bg-blue-900 text-white p-4 flex justify-between items-center shadow-md sticky top-0 z-50">
      {/* Convertimos el logo en un link para volver al inicio */}
      ...
      {/* Convertimos el carro en un link hacia /carrito */}
      <Link href="/carrito" className="bg-blue-800 px-4 py-2 rounded-lg flex items-center gap-3 cursor-pointer hover:bg-blue-700 transition-colors border border-blue-700">
